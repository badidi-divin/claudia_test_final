      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">Faites votre Commande sur Place</h1>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <div class="btn_main">
                                    <div class="buy_bt"><?php if($data->qte_stock!=0){?><a href="pannier-resto.php?action=ajout&amp;l=<?= $data->designation; ?>&amp;q=1&amp;p=<?= $data->prix; ?>" class="btn btn-success">Ajouter Au Panier</a><?php }else{echo "<h3 style='color:red;'>Stock épuisé!</h3>" ;} ?></div>
